...
export const COSTON_LIST = 'https://raw.githubusercontent.com/pangolindex/tokenlists/main/cflr.tokenlist.json'

export const DEFAULT_TOKEN_LISTS_SELECTED: string[] = [AVALANCHE_LIST, WAGMI_LIST, COSTON_LIST];

export const DEFAULT_TOKEN_LISTS: string[] = [AVALANCHE_LIST, WAGMI_LIST, COSTON_LIST];
