...
import { Box, Button, CurrencyInput, Loader, Stat, Text, TransactionCompleted } from '@pangolindex/core';
...
import { Field } from 'src/state/mint/elixir/atom';
import { useDerivedMintInfo, useMintActionHandlers, useMintState } from 'src/state/mint/elixir/hooks';
import { useElixirAddLiquidityHook } from 'src/state/wallet/elixir/hooks';
import { useDerivedPositionInfo } from 'src/state/wallet/elixir/hooks/evm';
