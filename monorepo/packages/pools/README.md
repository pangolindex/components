# Pools component
Components to interact with Pangolin's pools and farms.

## Installation
`yarn add @honeycomb-finance/pools`

or

`npm install @honeycomb-finance/pools`
...
See the [components readme](docs/components.md).
